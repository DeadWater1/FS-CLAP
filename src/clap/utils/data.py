...
from clap.clap_module.utils import get_tar_path_from_dataset_name, dataset_split
from clap.clap_module.utils import load_p, load_class_label
from clap.clap_module import tokenize as clip_tokenizer
...
bert_tokenizer = BertTokenizer.from_pretrained("bert-base-uncased", cache_dir='./checkpoints')
roberta_tokenizer = RobertaTokenizer.from_pretrained("roberta-base", cache_dir='./checkpoints')
bart_tokenizer = BartTokenizer.from_pretrained("facebook/bart-base", cache_dir='./checkpoints')
